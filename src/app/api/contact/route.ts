          ...
          <div style="padding: 30px;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
              ...
              <tr>
                ...
                <td style="padding: 12px 0; border-bottom: 1px solid #eeeeee;">${service}</td>
              </tr>
            </table>
    ...
    const userEmailHtml = `
      <div style="font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 40px 0; color: #020202;">
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
          ...
          <div style="padding: 30px;">
            <p style="font-size: 16px; margin-bottom: 20px; line-height: 1.5;">We have received your request for <strong>${service}</strong>. Our team at BeeBee Cleaning will review your information and get back to you shortly with a free quote.</p>
